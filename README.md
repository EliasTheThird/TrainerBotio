...
No data is stored off-platform or shared with third parties. All processing happens in memory and is discarded after each event.

**Is data used for AI/ML training?**

No.

**Questions?** Contact a server administrator.
